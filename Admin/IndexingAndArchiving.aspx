<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndexingAndArchiving.aspx.cs" Inherits="Admin_IndexingAndArchiving" ValidateRequest="false" %>
        ...
        <table width="750px">
            ...
            <tr>
                <td style="color: #0084E9; font-weight: bold; font-family: Arial, Helvetica, sans-serif">
                    Indexing &amp; Archiving Description :
                </td>
            </tr>
            <tr>
                <td>
                   <%-- <asp:TextBox ID="txtEditorIndexing" runat="server" Height="194px" 
                        Width="744"></asp:TextBox>
                    <cc1:HtmlEditorExtender ID="EditorIndexing" TargetControlID="txtEditorIndexing" 
                        runat="server">
                    </cc1:HtmlEditorExtender>--%>
                      <asp:TextBox ID="txtEditorIndexing" runat="server" Height="200px" TextMode="MultiLine" Width="744"></asp:TextBox>
                    <script type="text/javascript">
                        CKEDITOR.replace('txtEditorIndexing', { fullPage: true });
                    </script>
                </td>
            </tr>
            <tr>
