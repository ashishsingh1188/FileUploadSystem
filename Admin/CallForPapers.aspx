<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CallForPapers.aspx.cs" Inherits="Admin_CallForPapers" ValidateRequest="false" %>
...
<body>
    ...
    <div>
        ...
        <table width="750px">
            ...
            <tr>
                <td>
                   <%-- <asp:TextBox ID="txtEditorCallForPaper" runat="server" Height="194px" 
                        Width="744"></asp:TextBox>
                    <cc1:HtmlEditorExtender ID="EditorCallForPaper" TargetControlID="txtEditorCallForPaper" 
                        runat="server">
                    </cc1:HtmlEditorExtender>--%>
                     <asp:TextBox ID="txtEditorCallForPaper" runat="server" Height="200px" TextMode="MultiLine" Width="744"></asp:TextBox>
                    <script type="text/javascript">
                        CKEDITOR.replace('txtEditorCallForPaper', { fullPage: true });
                    </script>
                </td>
            </tr>
            <tr>
