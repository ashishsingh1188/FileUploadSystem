<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CallPapersPageUpload.aspx.cs" Inherits="CallPapersPageUpload" %>
    ...
    <table width="800px">
        ...
        <tr>
            <td align="left">
                    ...
                    <asp:GridView ID="GridViewFiles0" runat="server" AutoGenerateColumns="False" 
                        DataKeyNames="ID" Width="800px" 
                        onrowdeleting="GridViewFiles_RowDeleting" Font-Names="Arial" 
                        Font-Size="12px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CallFile" HeaderText="Uploaded File" />
                            <asp:BoundField DataField="CallExt" HeaderText="File Extension" />
                            <asp:BoundField DataField="CallDate" HeaderText="Date" ApplyFormatInEditMode="False" />
                             <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" ID="btmimg_delete0" CommandName="Delete" 
                                        ImageUrl="~/images/trash-icon.png" ToolTip="Delete File" 
